 ...
 *
 * This example shows how to control dexterous hand joint movements using different torque percentages.
 * Torque parameter range: 0-100%, higher values produce higher output torque.
 *
 * Note:
...
int main() {
    ...
    std::cout << "Demonstrating fist movements at 20%, 40%, 60%, 80%, 100% torque" << std::endl;
    ...
    for (uint8_t torque : torque_levels) {
        std::cout << ">>> Executing fist, torque: " << static_cast<int>(torque) << "%" << std::endl;
        ...
        std::cout << ">>> Opening hand, torque: " << static_cast<int>(torque) << "%" << std::endl;
    ...
    std::cout << "\n========== Demo 2: Torque control for OK gesture ==========" << std::endl;
    std::cout << "Executing OK gesture with different torque to simulate gentle and firm pinching\n" << std::endl;

    // Define OK gesture
    std::vector<JointCommand> ok_joints = {
        {JointId::THUMB_PIP, 40.0f, 50, 0},
        {JointId::THUMB_MCP, 30.0f, 50, 0},
        {JointId::THUMB_SWING, 30.0f, 50, 0},
        {JointId::THUMB_ROTATION, 4.0f, 50, 0},
    ...
    std::cout << "\n========== Demo 3: Different torque for different fingers ==========" << std::endl;
    std::cout << "Setting different torque for each finger to simulate real grasping scenarios\n" << std::endl;

    // Simulate grasping object: thumb and index finger with high torque, other fingers relaxed
    ...
    std::cout << "\n========== Demo 4: Gradual torque control ==========" << std::endl;
    ...
    // ========== Demo completed ==========
    std::cout << "\n========== Torque control demo completed ==========" << std::endl;
    std::cout << "Key points:" << std::endl;
    std::cout << "1. Torque parameter range: 0-100%" << std::endl;
    std::cout << "2. Higher torque values produce higher output torque and stronger grip" << std::endl;
    std::cout << "3. Low torque is suitable for gentle operations and handling fragile items" << std::endl;
    std::cout << "4. High torque is suitable for grasping operations requiring more force" << std::endl;
    std::cout << "5. Each joint can be set with individual torque" << std::endl;
    std::cout << "6. Different torque combinations can simulate real grasping scenarios" << std::endl;
