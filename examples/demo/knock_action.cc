...
std::vector<JointCommand> MakeKnockPose() {
    return {
        ...
        {JointId::FF_PIP, 75.0f, 100, 100}, {JointId::FF_MCP, 0.0f, 100, 100}, {JointId::FF_SWING, 0.0f, 100, 100},
        {JointId::MF_PIP, 75.0f, 100, 100}, {JointId::MF_MCP, 0.0f, 100, 100},
...
int main() {
    ...
    while (true) {
        ...
        if (!Knock(hand)) {
            std::cout << "Round " << gesture_cycle << " knock action execution failed" << std::endl;
            break;
        }
