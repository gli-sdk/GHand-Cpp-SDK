...
std::vector<JointCommand> MakeThumbPress() {
    return {
        ...
        {JointId::FF_PIP, 75.0f, 100, 100}, {JointId::FF_MCP, 70.0f, 100, 100}, {JointId::FF_SWING, 0.0f, 100, 100},
        {JointId::MF_PIP, 75.0f, 100, 100}, {JointId::MF_MCP, 70.0f, 100, 100},
        {JointId::RF_PIP, 75.0f, 100, 100}, {JointId::RF_MCP, 70.0f, 100, 100},
        {JointId::LF_PIP, 74.0f, 100, 100}, {JointId::LF_MCP, 70.0f, 100, 100},
    };
}
...
std::vector<JointCommand> MakeMiddlePress() {
    return {
        {JointId::THUMB_PIP, 60.0f, 100, 100}, {JointId::THUMB_MCP, 0.0f, 100, 100},
        {JointId::THUMB_SWING, 20.0f, 100, 100}, {JointId::THUMB_ROTATION, 0.0f, 100, 100},
        {JointId::FF_PIP, 75.0f, 100, 100}, {JointId::FF_MCP, 70.0f, 100, 100}, {JointId::FF_SWING, 0.0f, 100, 100},
...
std::vector<JointCommand> MakeRingPress() {
    return {
        {JointId::THUMB_PIP, 66.0f, 100, 100}, {JointId::THUMB_MCP, 0.0f, 100, 100},
        {JointId::THUMB_SWING, 20.0f, 100, 100}, {JointId::THUMB_ROTATION, 0.0f, 100, 100},
        {JointId::FF_PIP, 75.0f, 100, 100}, {JointId::FF_MCP, 70.0f, 100, 100}, {JointId::FF_SWING, 0.0f, 100, 100},
        {JointId::MF_PIP, 75.0f, 100, 100}, {JointId::MF_MCP, 70.0f, 100, 100},
...
int main() {
    ...
    while (true) {
        ...
        if (!Press(hand)) {
            std::cout << "Round " << gesture_cycle << " press action execution failed" << std::endl;
            break;
        }
