...
\n
  ...
  return {
      {JointId::THUMB_PIP, 50.0f, 100, 100},
      {JointId::THUMB_MCP, 40.0f, 100, 100},
      {JointId::THUMB_SWING, 30.0f, 100, 100},
      {JointId::THUMB_ROTATION, 0.0f, 100, 100},
      {JointId::FF_PIP, 59.0f, 100, 100},
      {JointId::FF_MCP, 69.0f, 100, 100},
      {JointId::FF_SWING, 0.0f, 100, 100},
      {JointId::MF_PIP, 60.0f, 100, 100},
      {JointId::MF_MCP, 56.0f, 100, 100},
      {JointId::RF_PIP, 60.0f, 100, 100},
      {JointId::RF_MCP, 54.0f, 100, 100},
      {JointId::LF_PIP, 62.0f, 100, 100},
      {JointId::LF_MCP, 64.0f, 100, 100},
  };
}
...
int main() {
  ...
  while (true) {
    ...
    if (!Grab(*hand)) {
      std::cout << "第 " << gesture_cycle << " 轮演示中的抓取动作执行失败"
                << std::endl;
      break;
    }
