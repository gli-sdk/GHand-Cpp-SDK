...
std::vector<JointCommand> MakeHoldPose() {
    return {
        {JointId::THUMB_PIP, 10.0f, 100, 100}, {JointId::THUMB_MCP, 25.0f, 100, 100},
        {JointId::THUMB_SWING, 30.0f, 100, 100}, {JointId::THUMB_ROTATION, 0.0f, 100, 100},
        {JointId::FF_PIP, 70.0f, 100, 100}, {JointId::FF_MCP, 65.0f, 100, 100}, {JointId::FF_SWING, 0.0f, 100, 100},
        {JointId::MF_PIP, 70.0f, 100, 100}, {JointId::MF_MCP, 65.0f, 100, 100},
        {JointId::RF_PIP, 70.0f, 100, 100}, {JointId::RF_MCP, 60.0f, 100, 100},
        {JointId::LF_PIP, 70.0f, 100, 100}, {JointId::LF_MCP, 65.0f, 100, 100},
    };
}
...
int main() {
    ...
    while (true) {
        ...
        if (!Hold(hand)) {
            std::cout << "Round " << gesture_cycle << " hold action execution failed" << std::endl;
            break;
        }
