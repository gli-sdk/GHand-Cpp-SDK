...
std::vector<JointCommand> MakeHoldPose() {
    return {
        {JointId::THUMB_PIP, 10.0f}, {JointId::THUMB_MCP, 25.0f},
        {JointId::THUMB_SWING, 30.0f}, {JointId::THUMB_ROTATION, 0.0f},
        {JointId::FF_PIP, 70.0f}, {JointId::FF_MCP, 65.0f}, {JointId::FF_SWING, 0.0f},
        {JointId::MF_PIP, 70.0f}, {JointId::MF_MCP, 65.0f},
        {JointId::RF_PIP, 70.0f}, {JointId::RF_MCP, 60.0f},
        {JointId::LF_PIP, 70.0f}, {JointId::LF_MCP, 65.0f},
    };
}
