...
public:
    ...
    using ForceCallback = std::function<void(FingerType, const std::vector<Force>&)>;
...
private:
    ...
    static constexpr float FORCE_THRESHOLD = 0.5f;           // 0.5牛顿
