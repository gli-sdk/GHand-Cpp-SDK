...
private:
    bool SendRecvCmd(canfd::FunctionCode fc,
                     const uint8_t* param,
                     uint8_t param_len,
                     std::vector<uint8_t>* response,
                     int timeout_ms = 500);
    bool SendCmdOnly(canfd::FunctionCode fc,
                     const uint8_t* param,
                     uint8_t param_len);
...
private:
    ...
    std::map<std::pair<uint8_t, canfd::FrameType>, canfd::PacketAssembler> assemblers_;
